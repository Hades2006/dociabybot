...
module.exports = (client) => {
  ...
  const bilgiler = {
    oauthSecret: "vQBYcLHZNu9CZQfMP-vYUWl7qn16uvjc",
    callbackURL: `https://panelblocker.glitch.me/callback`,
    domain: `https://panelblocker.glitch.me/`
  };
  ...
  app.get("/callback", passport.authenticate("discord", { failureRedirect: "/autherror" }), async (req, res) => {
    ...
    client.channels.get("592809400469684226").send(`**${client.users.get(req.user.id).tag}** adlı kullanıcı Web Paneline Discord hesabıyla giriş yaptı!`)
